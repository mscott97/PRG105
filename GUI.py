...
class CrudGUI:
    ...
    def open_menu(self):
        if self.radio_var.get() == 1:
            ...
            search = Change_customer_emailGUI
...
class AddGUI:
    def __init__(self, master):
        ...
        # widgets for top frame
        self.search_label = tkinter.Label(self.top_frame, text='Enter a customer name to add too: ')
        self.search_entry = tkinter.Entry(self.top_frame, width=15)
    ...
    def add(self):
        ...
        result = self.customers.get(name, 'Not Found')
        self.value.set(result)
        self.yes_button = tkinter.Button(self.bottom_frame, text='Yes', command=self.add1)
        self.no_button = tkinter.button(self.bottom_frame, text='no', command=self.back)
    ...
    def add1(self):
        ...
        result = self.customers.get(name, 'Not Found')
        self.value.set(result)
        customer_file.dat[name] = email   

    def back(self):
        self.look.destroy()


class Change_customer_emailGUI:
    def __init__(self, master):
        ...
        # widgets for top frame
        self.search_label = tkinter.Label(self.top_frame, text='Change a customer email: ')
        self.search_entry = tkinter.Entry(self.top_frame, width=15)
...
class DeleteGUI:
    def __init__(self, master):
        ...
        # widgets for top frame
        self.search_label = tkinter.Label(self.top_frame, text='Delete a customer: ')
        self.search_entry = tkinter.Entry(self.top_frame, width=15)
        ...
        # buttons for bottom frame
        self.search_button = tkinter.Button(self.bottom_frame, text='Search', command=self.delete)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.back)
    ...
    def delete(self):
        ...
        result = self.customers.get(name, 'Not Found')
        self.value.set(result)
        self.yes_button = tkinter.Button(self.bottom_frame, text='Yes', command=self.delete1)
        self.no_button = tkinter.button(self.bottom_frame, text='no', command=self.back)
        self.yes_button.pack(side='left')
        self.no_button.pack(side='left')
